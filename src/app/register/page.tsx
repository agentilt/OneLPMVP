        ...
        <div className="w-full max-w-md">
          ...
          <div className="glass-panel rounded-2xl shadow-2xl shadow-black/10 border border-border p-8">
            <div className="text-center">
              ...
              <Link
                href="/login"
                className="inline-flex items-center gap-2 px-6 py-3 bg-accent hover:bg-accent-hover text-white rounded-xl font-semibold shadow-lg shadow-accent/25 hover:shadow-accent/40 transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98]"
              >
                Go to Login
      ...
      <div className="w-full max-w-md">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  value={email}
                  disabled
                  className="w-full pl-12 pr-4 py-3 border border-border rounded-xl bg-[var(--surface-hover)] cursor-not-allowed opacity-70"
                />
              </div>
            </div>
            ...
            <div className="space-y-4 p-4 glass-panel border border-border">
