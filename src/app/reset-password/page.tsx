      ...
      <div className="min-h-screen flex items-center justify-center glass-page p-4">
        <div className="w-full max-w-md">
          ...
          >
            ...
            <p className="text-foreground/70 mb-6">This password reset link is invalid or has expired.</p>
            <Link
              href="/login"
      ...
      <div className="min-h-screen flex items-center justify-center glass-page p-4">
        <div className="w-full max-w-md">
          ...
          >
            ...
            <p className="text-foreground/70 mb-6">Your password has been updated. Redirecting to login...</p>
