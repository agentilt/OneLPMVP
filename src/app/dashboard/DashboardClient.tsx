              ...
              <div className="flex flex-col xl:flex-row xl:items-start justify-between gap-6">
                <div className="space-y-3 text-foreground">
                  <div className="space-y-2">
                    <p className="text-xs uppercase tracking-[0.22em] font-semibold text-foreground drop-shadow-lg">Copilot</p>
                    <h1 className="text-3xl sm:text-4xl lg:text-5xl font-semibold text-foreground leading-tight drop-shadow-[0_2px_8px_rgba(0,0,0,0.32)]">
                      Ask OneLP AI
                    </h1>
                    <p className="text-sm sm:text-base text-foreground max-w-2xl drop-shadow-lg">
